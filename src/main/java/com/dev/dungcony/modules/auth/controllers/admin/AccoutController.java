...
public class AccoutController {
    ...
    public ResponseEntity<ApiRes<?>> cAdmin(@Valid @RequestBody LoginReq req) {
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(ApiRes.success(accountCreateService.createAdminAccount(req.username(), req.password())));
    }
}
